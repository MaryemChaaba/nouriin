  ...
  return (
    <Container className="py-8">
          ...
          <div className="bg-background rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                deleteCartProduct(cartItem.product._id)
                              }
            ...
            {cartItemsWithQuantities.length > 0 && (
              <div className="text-center py-4 text-gray-500">
                You&apos;ve loaded all {cartItemsWithQuantities.length} items in
                your cart
              </div>
            )}
      ...
      <Dialog open={isCheckingOut}>
        <DialogContent
          className="sm:max-w-md [&>button]:hidden flex flex-col items-center justify-center p-8 z-[100]"
        ...
        >
          ...
          <p className="text-sm text-muted-foreground text-center px-4 leading-relaxed">
            Please wait while we secure your items and prepare your secure
            checkout. <br />
